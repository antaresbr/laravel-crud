...
class UserCrudStoreTest extends UserCrudAbstractTestCase
{
    ...
    public function store_one_successful()
    {
        ...
        $this->assertCount(2, $this->testModelClass::all());
    }
    ...
    public function store_many_with_partial_success()
    {
        ...
        $this->assertCount(5, $this->testModelClass::all());
    }
    ...
    public function store_many_successful()
    {
        ...
        $data['data'] = ['items' => $this->makeModels(40)];
        ...
        $this->assertTrue(Arr::has($json, 'data.successful'));
        $this->assertIsArray(Arr::get($json, 'data.successful'));
        $this->assertCount(40, Arr::get($json, 'data.successful'));
        foreach(array_keys(Arr::get($data, 'data.items')) as $key) {
        ...
        $this->assertCount(45, $this->testModelClass::all());
    }
}
