...
class CrudHttpErrors extends AbstractHttpErrors
{
    ...
    public const DATA_MODEL_UPDATE_FAIL = 991013;
    public const DATA_MODEL_DELETE_FAIL = 991014;
    public const TARGET_DATA_MODEL_NOT_FOUND = 991015;
    public const TARGET_DATA_MODIFIED_BY_OTHERS = 991016;
